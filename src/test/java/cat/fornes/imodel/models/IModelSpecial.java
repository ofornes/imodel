...
/**
 * A special model with a non-standard javaBean method.
 * @author Octavi Fornés <a href="mailto:ofornes@albirar.cat">ofornes@albirar.cat</a>
 * @since 1.1.0
 */
public interface IModelSpecial extends IModel
{
    /**
     * A special method to test the {@link IDelegateMethodDispatcher} use.
     * @param value A value to translate
     * @return The numeric value
     */
    public int translateValue(String value);
}
